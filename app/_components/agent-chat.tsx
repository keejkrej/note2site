...
export function AgentChat() {
  ...
  const composer = (
    <PromptInput onSubmit={handleSubmit}>
      <PromptInputTextarea placeholder="Paste lecture notes or describe a course to convert into a Next.js site…" />
        ...
        {isEmpty ? (
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <p className="max-w-md text-muted-foreground text-sm">
              Convert lecture notes into a full-stack Next.js course website.
            </p>
            <a
              className="rounded-full border border-amber-500/30 px-2 py-0.5 font-medium text-amber-700 text-xs transition-colors hover:bg-amber-500/10 dark:text-amber-300"
              href={BETA_TERMS_HREF}
